...
export default function PaymentButtons() {
	...
	const handleOrderSubmission = () => {
		...
		if (kdsOrderItems && kdsOrderItems.length > 0) {
	...
	const handleKdsToggle = (index: number) => {
		// Map over the current array (no functional updater)
		const updatedItems = kdsOrderItems.map((itm, i) => {
